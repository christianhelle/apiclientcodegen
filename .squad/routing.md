...
|-----------|----------|----------|
| Architecture & design | Morpheus | Solution structure, code generator patterns, ICodeGenerator interface changes |
| Core libraries & CLI | Neo | ApiClientCodeGen.Core, rapicgen CLI, DependencyInstaller, ProcessLauncher |
| Code generators | Neo | NSwag, OpenAPI Generator, Swagger Codegen, Refitter, Kiota, AutoRest wrappers |
| VS Code extension | Trinity | TypeScript extension, package.json, commands, context menus |
| VSIX extensions | Trinity | Visual Studio custom tools, IVsSingleFileGenerator, VS 2022/2026 |
| JetBrains plugin | Trinity | IntelliJ/Rider plugin, Java source |
...
| `squad:morpheus` | Architecture review, scoping | Morpheus |
| `squad:neo` | Core library work, CLI, code generators | Neo |
| `squad:trinity` | Extension work (VS Code, VSIX, JetBrains) | Trinity |
| `squad:tank` | Test writing, quality assurance | Tank |
