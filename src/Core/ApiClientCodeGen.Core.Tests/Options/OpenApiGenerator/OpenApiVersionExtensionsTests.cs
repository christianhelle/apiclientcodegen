...
public class OpenApiVersionExtensionsTests
{
    ...
    [Theory]
    [InlineData(OpenApiSupportedVersion.V7170, true)]   // Latest version
    ...
    [InlineData(OpenApiSupportedVersion.V7170, false)]  // Equal to latest version
    ...
    [Theory]
    [InlineData(OpenApiSupportedVersion.Latest, OpenApiSupportedVersion.V7170)]
