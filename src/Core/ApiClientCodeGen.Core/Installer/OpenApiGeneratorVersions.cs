...
public static class OpenApiGeneratorVersions
{
    ...
    [
        new(
            "7.25.0",
            $"{DownloadUrlPrefix}/7.25.0/openapi-generator-cli-7.25.0.jar",
            "56a9bb79e3bb565f477eddca2c6daa288a9c6f35",
            "e01eddf220074439f733bdf6e8c3daad"
        ),
        new(
            "7.24.0",
        ...
        new(
            ...
            "aa154752b82c9b84151cd4998ce2a86ed21f5bd3",
            "24803a056bc36a4f8824612fb31c8133"
        ),
        new(
            "7.21.0",
            $"{DownloadUrlPrefix}/7.21.0/openapi-generator-cli-7.21.0.jar",
            "19480dd1572a344c69a26c7488eda13f3caaf14e",
            "5925081963d078083af5380fd62317d4"
        ),
        new(
            "7.20.0",
