    ...
    public class DependencyInstaller : IDependencyInstaller
    {
        ...
        public void InstallNSwag()
        {
            ...
            try
            {
                ...
                if (!nswagVersion.Contains("14.7.0"))
                {
        ...
        private void InstallNSwagTool()
        {
            ...
            var arguments = "tool install --global NSwag.ConsoleCore --version 14.7.0";
        ...
        {
            var command = PathProvider.GetDotNetPath();
            var arguments = "tool update --global NSwag.ConsoleCore --version 14.7.0";
            using var context = new DependencyContext(command, $"{command} {arguments}");
            processLauncher.Start(command, arguments);
            context.Succeeded();
        }
        ...
        public void InstallKiota()
        {
            ...
            try
            {
                ...
                if (!kiotaVersion.StartsWith("1.31.0"))
                { 
            ...
            catch (Win32Exception)
            {
                ...
                arguments = "tool install --global Microsoft.OpenApi.Kiota --version 1.31.0";
                using var context = new DependencyContext(command, $"{command} {arguments}");
                processLauncher.Start(command, arguments);
                context.Succeeded();
            }
