    ...
    public class OpenApiCSharpCodeGenerator : ICodeGenerator
    {
        ...
        public string GenerateCode(IProgressReporter? pGenerateProgress)
        {
            ...
            try
            {
                ...
                {
                    var versionString = openApiGeneratorOptions.Version.GetType()
                        .GetField(openApiGeneratorOptions.Version.ToString())
                        ?.GetCustomAttributes(typeof(DescriptionAttribute), false)
                        .FirstOrDefault() is DescriptionAttribute descriptionAttribute
                        ? descriptionAttribute.Description
                        : openApiGeneratorOptions.Version.ToString();
                    ...
                    if (openApiGeneratorOptions.Version.IsAtLeast(OpenApiSupportedVersion.V7120))
                    {
