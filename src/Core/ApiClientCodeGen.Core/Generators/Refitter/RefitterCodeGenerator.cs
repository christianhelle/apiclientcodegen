...
public class RefitterCodeGenerator : ICodeGenerator
{
    ...
    private string GenerateFromSettingsFile(IProgressReporter? pGenerateProgress)
    {
        ...
        if (File.Exists(outputFilePath))
        {
            ...
            return GeneratedCode.PrefixAutogeneratedCodeHeader(
                generatedCode, ExternalTools.Refitter.DisplayName, ExternalTools.Refitter.VersionLabel);
        }

        pGenerateProgress?.Progress(100);
        return GeneratedCode.PrefixAutogeneratedCodeHeader(
            string.Empty, ExternalTools.Refitter.DisplayName, ExternalTools.Refitter.VersionLabel);
    }
    ...
    private string BuildRefitterArguments(string inputFile, string outputPath, bool multipleFiles = false)
    {
