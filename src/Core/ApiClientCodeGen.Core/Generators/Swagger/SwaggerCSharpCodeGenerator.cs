    ...
    public class SwaggerCSharpCodeGenerator : ICodeGenerator
    {
        ...
        public string GenerateCode(IProgressReporter? pGenerateProgress)
        {
            ...
            try
            {
                ...
                new ToolRunner(processLauncher).RunJava(ExternalTools.SwaggerCodegen, options, arguments);
                ...
                return GeneratedCode
                    .PrefixAutogeneratedCodeHeader(
                        ...
                        ExternalTools.SwaggerCodegen.DisplayName,
                        ExternalTools.SwaggerCodegen.VersionLabel);
            }
            finally
            {
