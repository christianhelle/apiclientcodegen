...
namespace ChristianHelle.DeveloperTools.CodeGenerators.ApiClient.IntegrationTests.Generators
{
    ...
    public class AutoRestVisualBasicCodeGeneratorTests
    {
        ...
        {
            var codeGenerator = new AutoRestVisualBasicCodeGenerator(
        ...
        [TestMethod]
        public void AutoRest_VisualBasic_Generated_Code_NotNullOrWhitespace()
            => code.Should().NotBeNullOrWhiteSpace();

        [TestMethod]
        public void AutoRest_VisualBasic_Reports_Progres()
            => mock.Verify(
