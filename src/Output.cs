...
{
    /// <summary>Swagger Petstore</summary>
    ...
    public partial interface ISwaggerPetstore
    {
        ...
        /// </exception>
        [Post("/pet/{petId}")]
        Task UpdatePetWithForm(long petId, string name, string status);
        ...
        Task<ApiResponse> UploadFile(long petId, string additionalMetadata, StreamPart file);
