...
class GenerateTypeScriptAction(private val generatorType: String, private val generatorDisplayName: String) : AnAction() {
    override fun actionPerformed(e: AnActionEvent) {
        ...
        val outputDirPath = if (outputDirectory.isBlank()) {
            File(specificationFilePath).parent + File.separator + "typescript-generated-code"
        } else {
            project.basePath + File.separator + outputDirectory
        }
        ...
        val command = "rapicgen typescript $generatorType "$specificationFilePath" "$outputDirPath""
        executeRapicgenCommand(project, command, generatorDisplayName)
    }
