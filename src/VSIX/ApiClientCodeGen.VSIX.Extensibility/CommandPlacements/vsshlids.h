...
//////////////////////////////////////////////////////////////////////////////
  ...
  // Guid for the Solution Loading accelerator keys - key binding scope only available while opening solution
  DEFINE_GUID (guidKeySolutionOpening,
    0xdc483bae, 0x41b7, 0x4822, 0x8c, 0x13, 0x62, 0xd6, 0xb5, 0x74, 0xb3, 0xc8);
  ...
  // Guid for AccentColorSwatches
  // {A1FA08E5-519B-4810-BDB0-89F586AF37E9}
  DEFINE_GUID(guidAccentColorSwatches,
        0xa1fa08e5, 0x519b, 0x4810, 0xbd, 0xb0, 0x89, 0xf5, 0x86, 0xaf, 0x37, 0xe9);
  ...
  // {952691c5-34d6-462b-ac56-9ab09770a30d}
  ...
  // new command set for Dev17
  // {43F755C7-7916-454D-81A9-90D4914019DD}
  DEFINE_GUID(CMDSETID_StandardCommandSet17,
    0x43f755c7, 0x7916, 0x454d, 0x81, 0xa9, 0x90, 0xd4, 0x91, 0x40, 0x19, 0xdd);

  // new command set for Dev18
  // {638DE876-EB38-48F0-A64F-D08B7938A9E8}
  DEFINE_GUID(CMDSETID_StandardCommandSet18,
    0x638de876, 0xeb38, 0x48f0, 0xa6, 0x4f, 0xd0, 0x8b, 0x79, 0x38, 0xa9, 0xe8);
  ...
  // Guid for Extension Management Package
  //{5DD582D8-4665-49E4-B74D-D376FB4CE60B}
  DEFINE_GUID(guidExtensionManagementPkg,
    0x5dd582d8, 0x4665, 0x49e4, 0xb7, 0x4d, 0xd3, 0x76, 0xfb, 0x4c, 0xe6, 0x0b);
  ...
  // Guid for UICONTEXT_SolutionReloading
  // {8838F531-22EE-420F-A642-C09E937933C6}
  DEFINE_GUID(guidUICONTEXT_SolutionReloading,
    0x8838f531, 0x22ee, 0x420f, 0xa6, 0x42, 0xc0, 0x9e, 0x93, 0x79, 0x33, 0xc6);

  // Guid for UICONTEXT_VsCriticalSection
  // {0394665A-6FF2-4614-B3E7-3B72FC5BB862}
  DEFINE_GUID(guidUICONTEXT_VsCriticalSection,
    0x0394665a, 0x6ff2, 0x4614, 0xb3, 0xe7, 0x3b, 0x72, 0xfc, 0x5b, 0xb8, 0x62);
...
///////////////////////////////////////////////
  ...
  // Guid for AccentColorSwatches
  #define guidAccentColorSwatches { 0xa1fa08e5, 0x519b, 0x4810, { 0xbd, 0xb0, 0x89, 0xf5, 0x86, 0xaf, 0x37, 0xe9 } }
  // Guid for the duplicate accelerator keys
  #define guidKeyDupe             { 0xf17bdae0, 0xa16d, 0x11d0, { 0x9f, 0x4,  0x0,  0xa0, 0xc9, 0x11, 0x0,  0x4f } }
  // Guid for the Solution Opening accelerator keys - key binding scope only available while opening solution
  #define guidKeySolutionOpening  { 0xdc483bae, 0x41b7, 0x4822, { 0x8c, 0x13, 0x62, 0xd6, 0xb5, 0x74, 0xb3, 0xc8 } }
  // Guid for Shell's group and menu ids
  ...
  // Guid for Standard Shell Commands (Dev17 set)
  #define CMDSETID_StandardCommandSet17 {0x43f755c7, 0x7916, 0x454d, {0x81, 0xa9, 0x90, 0xd4, 0x91, 0x40, 0x19, 0xdd}};
  // Guid for Standard Shell Commands (Dev18 set)
  #define CMDSETID_StandardCommandSet18 {0x638de876, 0xeb38, 0x48f0, {0xa6, 0x4f, 0xd0, 0x8b, 0x79, 0x38, 0xa9, 0xe8}};
  ...
  // Guid for Time bitmaps
  #define guidToolWindowTimestampButton { 0x5bf14e63, 0xe267, 0x4787, { 0xb2, 0x0b, 0xb8, 0x14, 0xfd, 0x04, 0x3b, 0x38} }
  ...
  // Guid for Extension Management Package
  #define guidExtensionManagementPkg { 0x5dd582d8, 0x4665, 0x49e4, { 0xb7, 0x4d, 0xd3, 0x76, 0xfb, 0x4c, 0xe6, 0x0b } }
  // Guid for Extension Manager Icon
...
// [obsolete] Do not use this value.  The UIContext to which it refers will never be activated.
...
#define guidVSStd17                 CMDSETID_StandardCommandSet17
#define CLSID_StandardCommandSet17  CMDSETID_StandardCommandSet17
#define guidVSStd18                 CMDSETID_StandardCommandSet18
#define CLSID_StandardCommandSet18  CMDSETID_StandardCommandSet18
...
#define IDG_VS_FILE_NEWP_CASCADE      0x0712
#define IDG_VS_FILE_NEWREPO_CASCADE   0x0713
#define IDG_VS_FILE_NEW_CASCADE       0x0119
#define IDG_VS_FILE_NEWF_CASCADE      0x0714
#define IDG_VS_FILE_OPENP_CASCADE     0x011A
#define IDG_VS_FILE_OPENF_CASCADE     0x011B
#define IDG_VS_FILE_OPENFOLDER_CASCADE 0x0715
#define IDG_VS_FILE_OPENREPO_CASCADE  0x0716
...
#define IDG_VS_PROJ_CONFIGURESTARTUP  0x014F // [Obsolete] This is no longer used
...
#define IDG_VS_WINDOW_SPLIT           0x0167  // Group for Split Tab
...
#define IDG_VS_DOCKEDWINDOWCLOSE  0x0193

// Thread context menu groups
#define IDG_VS_CALLST_RUNTOCURSOR     0x0191
// #define IDG_VS_DOCUMENTDOCKHIDE    0x0192 // Placeholder to prevent reuse
// #define IDG_VS_DOCKEDWINDOWCLOSE   0x0193 // Placeholder to prevent reuse
...
#define IDG_VS_PINNEDTABS               0x01EE  // Pinned/Promote/Set Tab Color
#define IDG_VS_EZ_TABORIENTATION        0x01EF  // Document well Set Tab Orientation
#define IDG_VS_WINDOW_MOVE              0x01FA  // Move to Tab Group Above/Below/Left/Right
...
// #define IDG_VS_WINDOW_MOVE       0x01FA  // Placeholder to prevent reuse
...
#define IDG_VS_OUTPUTWINDOW_TIMESTAMP 0x074C
...
#define IDG_VS_CTXT_PROJECT_CLASSDIAGRAM 0x02B8 // Obsolete
...
#define IDG_VS_CTXT_PROJECT_VIEW_GENERAL      0x02E3 // Obsolete
...
#define IDG_VS_FINDRESULTSTABLE_REPEATFIND    0x02F7
...
#define IDM_VS_CSCD_PROJECT_VIEW              0x035F // Obsolete
...
#define IDM_VS_DOCUMENT_DUPLICATE             0x0400
#define IDM_VS_EZ_TABCOLOR                    0x0401
#define IDM_VS_WINDOW_MOVE                    0x040A
#define IDM_VS_DOCUMENT_MOVE                  0x040B
//////////////////////////////////////////////////////////////////////////////
//
...
// #define IDM_VS_WINDOW_MOVE         0x040A // Placeholder to prevent reuse
// #define IDM_VS_DOCUMENT_MOVE       0x040B // Placeholder to prevent reuse
// UNUSED: 0x040C
...
// EZMdi context menus
#define IDM_VS_CTXT_EZTOOLWINTAB      0x042A  // Tool Tab context menu
#define IDM_VS_CTXT_EZDOCWINTAB       0x042B  // Document Tab context menu
...
#define IDM_VS_MNUCTRL_OPENPRJ                  0x051F
...
// #define IDM_VS_MNUCTRL_OPENPRJ               0x051F // Placeholder to prevent reuse
...
#define IDG_VS_TABOPT_COLORIZATION                  0x0748  // Group for tab colorization (none, by project, etc.)
#define IDG_VS_EZ_TAB_COLOR_SELECTION               0x0749  // Group for tab color selection (i.e., select from a range of colors)
#define IDG_VS_EZ_TAB_NOCOLOR_SELECTION             0x074A  // Group for command for "no tab color" selection
#define IDG_VS_TABOPT_MULTIROWTABS                  0x074B  // Group for command for multi-row tabs
                                                    // 0x074C is taken by IDG_VS_OUTPUTWINDOW_TIMESTAMP
