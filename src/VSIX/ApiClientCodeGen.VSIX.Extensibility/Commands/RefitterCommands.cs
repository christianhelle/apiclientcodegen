    ...
    : Command
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        else
        {
            ...
            var output = Rapicgen.Core.Generators.GeneratedCode.PrefixAutogeneratedCodeHeader(code, Rapicgen.Core.ExternalTools.Refitter.DisplayName, Rapicgen.Core.ExternalTools.Refitter.VersionLabel);
