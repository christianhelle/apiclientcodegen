...
public abstract class GenerateNSwagBaseCommand(TraceSource traceSource, ExtensionSettingsProvider settingsProvider) : Command
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            csharpCode = GeneratedCode.PrefixAutogeneratedCodeHeader(csharpCode, Rapicgen.Core.ExternalTools.NSwag.DisplayName, Rapicgen.Core.ExternalTools.NSwag.VersionLabel);
