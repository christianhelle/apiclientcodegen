...
namespace Rapicgen.CLI.Commands.VisualBasic
{
    ...
    public class RefitterVbCommandSettings : VisualBasicCodeGeneratorCommand<RefitterVbCommandSettings>.Settings
    {
    ...
    public class RefitterVbCommand : VisualBasicCodeGeneratorCommand<RefitterVbCommandSettings>
    {
        ...
        public override int Execute(CommandContext context, RefitterVbCommandSettings settings, CancellationToken cancellationToken)
        {
        ...
        public override ICodeGenerator CreateGenerator(RefitterVbCommandSettings settings) =>
