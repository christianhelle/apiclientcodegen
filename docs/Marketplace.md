...
There is a separate VSIX installer available for **[Visual Studio 2022 Preview](https://marketplace.visualstudio.com/items?itemName=ChristianResmaHelle.APIClientCodeGeneratorPreview)**
...
- ***NSwagCodeGenerator*** - Generates a single file C# REST API Client using the [NSwag.CodeGeneration.CSharp](https://github.com/RSuter/NSwag/wiki/SwaggerToCSharpClientGenerator) [nuget package](https://www.nuget.org/packages/NSwag.CodeGeneration.CSharp/) v13.13.1
...
- ***OpenApiCodeGenerator*** - Generates a single file C# REST API Client using **OpenAPI Generator v5.2.1**.
