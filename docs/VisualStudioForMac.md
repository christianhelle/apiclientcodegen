...
- ***KiotaCodeGenerator*** - Generates a single file C# REST API Client using the Microsoft project **[Kiota v1.25.1](https://learn.microsoft.com/en-us/openapi/kiota/)** generator. 
