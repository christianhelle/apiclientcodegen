...
- ***OpenApiCodeGenerator*** - Generates a single file C# REST API Client using **[OpenAPI Generator v7.6.0](https://github.com/OpenAPITools/openapi-generator/releases/tag/v7.6.0)**.
...
- ***RefitterCodeGenerator*** - Generates a single file C# REST API Client inteface for [Refit](https://github.com/reactiveui/refit) using [Refitter.Core](https://github.com/christianhelle/refitter) [nuget package](https://www.nuget.org/packages/Refitter.Core/) **v1.0.1**.
...
- [Polly](https://www.nuget.org/packages/Polly/8.4.0)
