...
- ***KiotaCodeGenerator*** - Generates a single file C# REST API Client using the Microsoft project **[Kiota v1.1.2](https://microsoft.github.io/kiota)** generator. 
...
- ***RefitterCodeGenerator*** - Generates a single file C# REST API Client inteface for [Refit](https://github.com/reactiveui/refit) using [Refitter.Core](https://github.com/christianhelle/refitter) [nuget package](https://www.nuget.org/packages/Refitter.Core/) **v0.4.1**.
...
- [Microsoft.Kiota.Http.HttpClientLibrary](https://www.nuget.org/packages/Microsoft.Kiota.Http.HttpClientLibrary/1.0.1)
...
Commands:
  ...
  openapi-generator  Generate code using OpenAPI Generator (v6.5.0).
...
Commands:
  ...
  kiota         Microsoft project Kiota (v1.1.2)
  nswag         NSwag (v13.18.2)
  openapi       OpenAPI Generator (v6.5.0)
  refitter      Refitter (v0.4.1)
