...
- ***KiotaCodeGenerator*** - Generates a single file C# REST API Client using the Microsoft project **[Kiota v1.12.0](https://learn.microsoft.com/en-us/openapi/kiota/)** generator. 
