...
- ***OpenApiCodeGenerator*** - Generates a single file C# REST API Client using **[OpenAPI Generator v7.18.0](https://github.com/OpenAPITools/openapi-generator/releases/tag/v7.18.0)**.
...
- ***RefitterCodeGenerator*** - Generates a single file C# REST API Client interface for [Refit](https://github.com/reactiveui/refit) using [Refitter.Core](https://github.com/christianhelle/refitter) [nuget package](https://www.nuget.org/packages/Refitter.Core/) **v1.7.1**.
...
Commands:
  ...
  nswag         NSwag (v14.6.3)
  openapi       OpenAPI Generator (v7.18.0)
  refitter      Refitter (v1.7.1)
