...
- ***KiotaCodeGenerator*** - Generates a single file C# REST API Client using the Microsoft project **[Kiota v1.9.0](https://learn.microsoft.com/en-us/openapi/kiota/)** generator. 
...
- ***RefitterCodeGenerator*** - Generates a single file C# REST API Client inteface for [Refit](https://github.com/reactiveui/refit) using [Refitter.Core](https://github.com/christianhelle/refitter) [nuget package](https://www.nuget.org/packages/Refitter.Core/) **v0.8.5**.
...
Commands:
  ...
  kiota         Microsoft Kiota (v1.9.0)
  nswag         NSwag (v13.20.0)
  openapi       OpenAPI Generator (v7.1.0)
  refitter      Refitter (v0.8.5)
