...
- ***KiotaCodeGenerator*** - Generates a single file C# REST API Client using the Microsoft project **[Kiota v1.1.0](https://microsoft.github.io/kiota)** generator. 
...
Commands:
  ...
  kiota         Microsoft project Kiota (v1.1.0)
