...
- ***OpenApiCodeGenerator*** - Generates a single file C# REST API Client using **[OpenAPI Generator v7.4.0](https://github.com/OpenAPITools/openapi-generator/releases/tag/v7.4.0)**.
...
- ***KiotaCodeGenerator*** - Generates a single file C# REST API Client using the Microsoft project **[Kiota v1.13.0](https://learn.microsoft.com/en-us/openapi/kiota/)** generator. 
...
- ***RefitterCodeGenerator*** - Generates a single file C# REST API Client inteface for [Refit](https://github.com/reactiveui/refit) using [Refitter.Core](https://github.com/christianhelle/refitter) [nuget package](https://www.nuget.org/packages/Refitter.Core/) **v0.9.9**.
...
Commands:
  ...
  openapi-generator  Generate code using OpenAPI Generator (v7.4.0).
...
Commands:
  ...
  kiota         Microsoft Kiota (v1.13.0)
  nswag         NSwag (v14.0.3)
  openapi       OpenAPI Generator (v7.4.0)
