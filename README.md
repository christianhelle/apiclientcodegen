...
- ***RefitterCodeGenerator*** - Generates a single file C# REST API Client inteface for [Refit](https://github.com/reactiveui/refit) using [Refitter.Core](https://github.com/christianhelle/refitter) [nuget package](https://www.nuget.org/packages/Refitter.Core/) **v1.5.3**.
...
Commands:
  ...
  kiota         Microsoft Kiota (v1.24.3)
  nswag         NSwag (v14.3.0)
  openapi       OpenAPI Generator (v7.12.0)
  refitter      Refitter (v1.5.3)
